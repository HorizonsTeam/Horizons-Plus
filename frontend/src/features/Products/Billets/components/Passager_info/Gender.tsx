...
export default function Gender_Selection({value, IsSelected, onClick}: Props) {
    return (
        <div>
            <button className={`w-22 h-10  bg-[#103035] rounded-2xl ml-3 border-3 ${IsSelected ? 'border-[#98EAF3]' : 'border-[#2C474B]' } text-white display flex justify-between p-2`} onClick={onClick} >
